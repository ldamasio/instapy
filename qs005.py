...
insta_username = 'primertvhdshow'
insta_password = 'primer'
...
with smart_run(session):
    ...
    session.set_comments([':thumbsup:', ':raising_hands:'
		        'Você é tão especial como um diamante :thumbsup:',
		        'Apenas inacreditável :open_mouth:',
		        'YOU R THE BO$$ @{}?',
		        'Amei suas postagens @{}',
		        'Parece incrível @{}',
		        'Sinto inspirado por você @{}',
		        ':raised_hands: Sim!',
		        'Fico esperando por suas postagens @{} :thumbsup: :muscle:'],
                         media='Photo')
    ...
    """
    session.follow_user_followers(['drviniciuskfisio', 'espacomichelekoerich', 'vivafisioclinica'], amount=125,
                                  randomize=False, interact=True,
                                  sleep_delay=600)

    """ Second follow user follows doesn't comment on users' posts...
    """
    session.follow_user_followers(['reabilitarfloripa', 'lifecorepilates'], amount=50,
